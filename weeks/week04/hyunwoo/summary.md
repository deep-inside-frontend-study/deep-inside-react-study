...
- React에서 배칭의 경우, flag를 두어 dirtyComponents 배열에 계속 push하고, 이 작업이 완료되면 한 번에 처리하는 것을 알게 되었다.
- 렌더링 작업 우선순위를 정하는 레인을 알게 되었다. 비트마스크를 통해 우선순위가 정해져있고 useTransition 등을 통해 우선순위를 낮출 수 있다.
