...
- 개인적으로 프론트엔드 개발자로서의 역량 중 하나는 사용자에게 부드러운 UI를 제공하는 것이라고 생각합니다. 리렌더링 횟술르 줄인다든지, 리플로우 비용을 줄인다는지 다양한 방면에서 최적화가 가능하겠지만 결국 리액트의 동시성이라는 하나의 카드도 잘 활용해야겠다고 생각합니다. 정확히 말하면 동시성을 활용해야만 하는 상황이 있습니다.
